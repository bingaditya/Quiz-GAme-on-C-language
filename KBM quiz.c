...
void playgame() 
{
     int countr,r,r1,count,i,n,j,c;
     float score;
     char choice,ch;
     char playername[20],co[]={"CONGRATULATION"};
     system("cls");
     system("color B4");
    printf("\n\n\n\n\n\n\n\n\n\n\t\t\tResister your name:");
     gets(playername);
    system("cls");
    system("color BC");
    printf("\n ------------------  Welcome %s to C Program Quiz Game --------------------------",strupr(playername));
    printf("\n\n Here are some tips you might wanna know before playing:");
    printf("\n -------------------------------------------------------------------------");
    printf("\n >> There are 2 rounds in this Quiz Game,WARMUP ROUND & CHALLANGE ROUND\n >> In WARMUP ROUND you will get 20 sec to give answer\n >> In CHALLANGE ROUND you will get 15 sec to give answer.");
    ...
    system("cls");
     ...
     switch(r1)
		...
		else if(toupper(ch)==0)
		{
			printf("\n\nThe correct answer is C.23232");
			getch();
			break;
		}
		else
		...
		{
			printf("\n\nThe correct answer is C.Switzerland");
			getch();
			break;
		}
		else
	...
	start();
	 ...
	 printf(" %s you are eligible to play the Game ***",playername);
     printf("\n\n\n\n\t!Press any key to Start the Game!");
     if(toupper(getch())=='p')
		{goto game;}
game:
    ...
    system("color B5");
     ...
     switch(r)
		{
		case 1:
		printf("\n\n%d. What is the National Game of England?",r);
		...
		case 2:
		printf("\n\n\n%d. Study of Earthquake is called............,",r);
		...
		if (toupper(ch)=='A')
		 ...
		 {
			printf("\n\nThe correct answer is A.Seismology");
			getch();
			break;
		 }
		else
        ...
        case 3:
		printf("\n\n\n%d. Among the top 10 highest peaks in the world, how many lie in Nepal? ",r);
		printf("\n\nA.6\t\tB.7\n\nC.8\t\tD.9");
		ch=timer1();
		if (toupper(ch)=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
        ...
        case 4:
		printf("\n\n\n%d. The Laws of Electromagnetic Induction were given by?",r);
		printf("\n\nA.Faraday\t\tB.Tesla\n\nC.Maxwell\t\t D.Coulomb");
		ch=timer1();
		if (toupper(ch)=='A')
			{printf("\n\nCorrect!!!");countr++;getch();
		...
		{
				printf("\n\nThe correct answer is A.Faraday");
			getch();
			break;
		}
		else
        ...
        case 5:
		printf("\n\n\n\n%d. What unit is electric power measured?",r);
		printf("\n\nA.Coulomb\t\tB.Watt\n\nC.Power\t\tD.Units");
		ch=timer();
		if (toupper(ch)=='B')
		...
		case 6:
		printf("\n\n\n%d. Which element is found in Vitamin B12?",r);
		printf("\n\nA.Zinc\t\tB.Cobalt\n\nC.Calcium\t\tD.Iron");
		ch=timer1();
		if (toupper(ch)=='B' )
			{
        ...
        case 7:
		printf("\n\n\n%d. What is the National Name of Japan?",r);
		printf("\n\nA.Polska\t\tB.Hellas\n\nC.Drukyul\t\tD.Nippon");
		ch=timer();
		if (toupper(ch)=='D')
			{printf("\n\nCorrect!!!");countr++;getch();
			 ...
			 {
			 		printf("\n\nThe correct answer is D.Nippon");
			getch();
			break;
			 }
		else
        ...
        case 8:
		printf("\n\n\n%d. How many times a piece of paper can be folded at the most?",r);
        ...
        case 9:
		printf("\n\n\n%d. What is the capital of Denmark?",r);
        ...
        case 10:
		printf("\n\n\n%d. Which is the longest River in the world?",r);
		printf("\n\nA.Nile\t\tB.Koshi\n\nC.Ganga\t\tD.Amazon");
		ch=timer();
		if (toupper(ch)=='A')
			{printf("\n\nCorrect!!!");countr++;getch(); break;}
